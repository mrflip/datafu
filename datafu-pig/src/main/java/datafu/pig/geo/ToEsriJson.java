...
public class ToEsriJson extends SimpleEvalFunc<String>
{
  public String call(String wkt)  {
    try {
      ...
      return GeometryEngine.geometryToJson(wkid, esriGeom);
    }
    catch (Exception err) {
  ...
  {
    return new Schema(new Schema.FieldSchema("esri_json", DataType.CHARARRAY));
  }
}
