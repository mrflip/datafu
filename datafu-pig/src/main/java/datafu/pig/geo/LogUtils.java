...
public class LogUtils {
	 ...
	 * @param geomref2
	 */
	public static void Log_SRIDMismatch(Log logger, OGCGeometry geom_1, OGCGeometry geom_2){
		logger.error(String.format(messages[MSG_SRID_MISMATCH], geom_1, geom_2));
	}
